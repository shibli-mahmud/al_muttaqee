  ...
  Widget? bottomNavigationBar() {
    return Obx(
        ...
        items:  [
          ...
          BottomNavigationBarItem(
            icon: Icon(PhosphorIconsRegular.stackOverflowLogo, size: AppValues.icon),
            activeIcon: Icon(PhosphorIconsFill.stackOverflowLogo, size: AppValues.icon),
            label: 'List',
          ),
          // BottomNavigationBarItem(
          //   icon: Icon(PhosphorIconsRegular.bell, size: AppValues.icon),
          //   activeIcon: Icon(PhosphorIconsFill.bell, size: AppValues.icon),
          //   label: 'Notifications',
          // ),
          BottomNavigationBarItem(
